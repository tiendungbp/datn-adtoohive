        ...
        <div className="col-md-6">
            <div className="row mb-3">
                <div className="col-md">
                    <h5 className="mb-3"> Lịch làm việc {""}
                        <span className="text-primary">{moment(props.date).format("DD-MM-YYYY")}</span>
                    </h5>
                    <hr/>
                </div>
            </div>
                ...
                <div className="col-md">
                    ...
                    >
                        <Spin tip="Đang tải..." spinning={modalLoading}>
                            ...
                            <div>
                                <p><b>Bác sĩ phụ trách:</b> {doctor ? doctor.fullname : ""}</p>
                                <p><b>Ngày hẹn:</b> {selectedSchedule ? moment(selectedSchedule.date).format("DD-MM-YYYY") : ""}</p>
                                <p><b>Ca khám:</b> {selectedSchedule ? selectedSchedule.Session.time : ""}</p>
                                <hr/>
                            </div>
                            <Form
                                form={form}
