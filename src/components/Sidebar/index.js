                ...
                <div className="d-flex align-items-center ms-4 mb-4">
                    <div className="position-relative">
                        <img
                            ...
                            src={user && user.avatar ? user.avatar : "https://cdn.landesa.org/wp-content/uploads/default-user-image.png"}
                            alt=""
                ...
                <div className="navbar-nav w-100">
                    ...
                    }
                    {
                        ...
                        <NavLink to="/benh-nhan" className="nav-item nav-link">
                            <i className="me-2"><FontAwesomeIcon icon={faUser}/></i>Bệnh nhân
                        </NavLink>
                        :
                        <></>
                    ...
                    }
                    {
                        ...
                        <NavLink to="/danh-muc" className="nav-item nav-link">
                            <i className="me-2"><FontAwesomeIcon icon={faList}/></i>Danh mục
                        </NavLink>
