    ...
    const columns = [
        {
            ...
            sorter: (a, b) => a.DoctorSchedule.Schedule.date > b.DoctorSchedule.Schedule.date
        },
        {
            title: "Ca khám",
            align: "center",
        ...
        },
        {
            ...
            showSorterTooltip: false,
            sorter: (a, b) => a.DoctorSchedule.Doctor.fullname.localeCompare(b.DoctorSchedule.Doctor.fullname)
        },
        {
        ...
        },
        {
            ...
            render: obj => CommonUtils.capitalizeEachWord(obj.Services.service_name)
        },
        {
            title: "Số lượng",
            align: "center",
        ...
        {
            title: "Mô tả",
            render: obj => CommonUtils.capitalizeFirstLetter(obj.Services.Detail.description)
        },
    ];
                    ...
                    <div className="col-md">
                        <div className="rounded p-4 bg-secondary">
                            <div className="row mb-3">
                                <div className="col-md">
                                    <Link to="/benh-nhan" className="text-decoration-none text-primary">
                                            ...
                                            <div className="row">
                                                <div className="col-md">
                                                    <Form.Item label="Mã bệnh nhân">
                                                        <p className="mb-0">{patient ? patient.patient_id.toUpperCase() : ""}</p>
                                                    </Form.Item>
                                                </div>
                                                <div className="col-md">
                                                    <Form.Item label="Họ và tên">
                                                        <p className="mb-0">{patient ? patient.fullname : ""}</p>
                                                    </Form.Item>
                                                </div>
                                                <div className="col-md">
                                                    <Form.Item label="Ngày sinh">
                                                        <p className="mb-0">{patient ? moment(patient.dob).format("DD-MM-YYYY") : ""}</p>
                                                    </Form.Item>
                                                </div>
                                                <div className="col-md">
                                                    <Form.Item label="Giới tính">
                                                        <p className="mb-0">{patient ? patient.gender ? "Nam" : "Nữ" : ""}</p>
                                                    </Form.Item>
                                                </div>
                                                <div className="col-md">
                                                    <Form.Item label="Số điện thoại">
                                                        <p className="mb-0">{patient ? patient.phone : ""}</p>
                                                    </Form.Item>
                                                </div>
                                                <div className="col-md">
                                                    <Form.Item label="Địa chỉ email">
                                                        <p className="mb-0">{patient ? patient.email : ""}</p>
                                                    </Form.Item>
                                                </div>
                                            </div>
                                        </Form>
