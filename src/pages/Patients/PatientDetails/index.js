...
import { Form, Input, DatePicker, Radio, Select, Button, Popconfirm, Spin, Alert, Modal } from "antd";
...
export default function PatientDetails() {
    ...
    useEffect(() => {
        if(patient && patient.district) {
            const district = districtList.find(item => item.name === patient.district);
            if(district) {
                                                ...
                                                <div className="col-md-2 mt-3">
                                                    <Form.Item label="Quận/huyện" name="district">
                                                        <Select
                                                            ...
                                                            disabled={city || (patient && patient.city) ? false : true}
                                                        />
                                                    </Form.Item>
                                                </div>
                                                <div className="col-md-2 mt-3">
                                                    <Form.Item label="Phường/xã" name="ward">
                                                        <Select
                                                            ...
                                                            disabled={district || (patient && patient.district) ? false : true}
                                                        />
                                                    </Form.Item>
                                                </div>
                                                <div className="col-md-4 mt-3">
                                                    <Form.Item label="Số nhà và tên đường" name="street">
                                                        <Input
                                                            ...
                                                            disabled={ward || (patient && patient.ward) ? false : true}
                                                        />
                                                    </Form.Item>
                                                </div>
                                            </div>
