...
import { faImage, faUserSlash, faEdit } from "@fortawesome/free-solid-svg-icons";
...
export default function PatientList() {
    ...
    const handleFilterByStatus = (code) => {
        if(code === -1) {
            ...
            const list = patientList.filter(patient => patient.is_activated === code);
            setSearchList(list);
        };
    };
    ...
    const handleSearchByInfo = () => {
        if(keyword) {
            ...
            else if(keyword.length === 10 && keyword.toLowerCase().slice(0, 2) === "bn") {
                ...
                <div className="row bg-light rounded mx-0 mb-4">
                    <div className="col-md">
                        <div className="rounded p-4 bg-secondary mb-4">
                            <div className="row">
                                <div className="col-md">
                                    <span className="text-dark page-title">QUẢN LÝ BỆNH NHÂN</span>
