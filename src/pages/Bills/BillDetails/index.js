		...
		if (selectedCategories.length) {
			...
			selectedServices.forEach((service) => {
				const quantity = selectedQuantities.find(
					(quantity) => quantity.rowId === service.rowId,
				).quantity;
								...
								<div className="row appointment-details">
									...
									<div className="col-md-4 mt-4">
										...
										<div className="d-flex">
											<div className="left-content">
												<p>
													<b className="text-dark">Mã hóa đơn:</b>
												</p>
												<p>
													<b className="text-dark">Người lập:</b>
												</p>
												<p>
													<b className="text-dark">Ngày lập:</b>
												</p>
												<p>
													<b className="text-dark">Trạng thái:</b>
												</p>
											</div>
											<div className="right-content">
												<p>
												...
												<p>
													{bill ? bill.Employee.fullname : 'Chưa có thông tin'}
												</p>
												<p>
													{bill
									...
									<div className="col-md-4 mt-4">
										...
										<div className="d-flex">
											<div className="left-content">
												<p>
													<b className="text-dark">Tổng tiền</b>
												</p>
											</div>
											<div className="right-content">
												<p>
											...
											<>
												{bill && bill.status ? (
													<div className="d-flex">
														<div className="left-content">
															<p>
																<b className="text-dark">Phương thức:</b>
															</p>
															<p>
																<b className="text-dark">Ngày T.Toán:</b>
															</p>
														</div>
														<div className="right-content">
			...
			>
				<Spin tip="Đang tải..." spinning={modalLoading}>
					<div ref={pdfRef} className="w-100 px-5 pt-5">
						...
						<div className="row">
							<div className="col-md-6 d-flex mt-4">
								...
								<div>
									...
									<p>{patient ? patient.fullname : ''}</p>
									<p>
										{patient ? moment(patient.dob).format('DD-MM-YYYY') : ''}
									</p>
									<p>{patient ? (patient.gender ? 'Nam' : 'Nữ') : ''}</p>
									<p>{patient ? patient.phone : ''}</p>
								</div>
							...
							<div className="col-md-6 d-flex mt-4">
								...
								<div>
									...
									<p>
										{bill ? moment(bill.createdAt).format('DD-MM-YYYY') : ''}
									</p>
									<p>
										{bill ? moment(bill.updatedAt).format('DD-MM-YYYY') : ''}
									</p>
									<p>{bill?.Method?.method_name}</p>
								</div>
							</div>
						...
						<div className="row">
							<div className="col-md mt-4">
								<h5 className="mb-4 text-end">
									Tổng tiền: {CommonUtils.VND.format(total)}
								</h5>
							</div>
						</div>
						<div className="row">
