...
export default function BookingAppointment() {
    ...
    useEffect(() => {
        if(
            (!selectedCategory && (selectedDate !== null || selectedDate !== "Invalid Date") && selectedSession) ||
    ...
    const handleChooseDate = (date) => {
        ...
        if(formattedDate === currentDate) {
            ...
            setSessionList(sessionList.filter(session => {
                    ...
                    <div className="col-md">
                        <div className="rounded p-4 bg-secondary mb-5">
                            <div className="row mb-3">
                                <div className="col-md">
                                    <Link to="/lich-hen/dat-lich-hen" className="text-decoration-none text-primary">
                                        <small><FontAwesomeIcon icon={faChevronLeft}/> Quay lại</small>
                                    </Link>
                                </div>
                            </div>
                            <Spin tip="Đang tải..." spinning={selectListLoading}>
                                <div className="row mb-3">
                                    <div className="col-md">
                                        <h5 className="text-uppercase text-primary mb-0">Đặt lịch hẹn</h5>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-md">
                        ...
                        <Spin tip="Đang tải..." spinning={doctorListLoading}>
